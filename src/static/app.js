document.addEventListener("DOMContentLoaded", () => {
  ...
  const loginActionButton = document.getElementById("login-action-button");
  const logoutActionButton = document.getElementById("logout-action-button");
  ...
  function updateAuthUi() {
    if (isTeacherLoggedIn()) {
      userStatus.textContent = `Teacher: ${teacherUsername}`;
      loginActionButton.classList.add("hidden");
      logoutActionButton.classList.remove("hidden");
      signupContainer.classList.remove("hidden");
    } else {
      userStatus.textContent = "Viewing as student";
  ...
  loginForm.addEventListener("submit", async (event) => {
    ...
    try {
      ...
      loginError.textContent = "Unable to log in right now. Please retry.";
      loginError.classList.remove("hidden");
